...
func Endpoints(group *echo.Group, svc *service.Service) {
	...
	demo, err := sarfya.NewExample(context.Background(), sarfya.Input{
		ID:   "demo",
		Text: "1Kaltxì, 2ulte 3zola'u 4nìprrte' 5fìweptseng6ne! 7(Pamrel si) 8lì'uor 9nefä 10fu 11takuk 12pumit 13mì 14fìpamrel 15fte 16fwivew.",
		LookupFilter: map[int]string{
			11: "vtr.",
		},
		Translations: map[string]string{
			"en": "1Hello, 2and 3+4(welcome) 6to 5(this website)! 7Write 8(a word) 9above 10or 11click 12one 13in 14(this writing) 15to 16search.",
		},
